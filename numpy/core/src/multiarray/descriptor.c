...
/* NEW DTYPES BLOCK START (until end of file) */
/* ****************************************************************** */


void *arraydtypemeta_init = NULL;
void *arraydtypemeta_new = NULL;
void *arraydtypemeta_dealloc = NULL;
...
NPY_NO_EXPORT PyTypeObject PyArrayDTypeMeta_Type = {
    ...
    0,                                          /* tp_itemsize */
    /* methods */
    0, //(destructor)blah_dealloc            /* tp_dealloc */
    0,                                          /* tp_print */
    0,                                          /* tp_getattr */
    0,                                          /* tp_setattr */
    (void *)0,                                  /* tp_reserved */
