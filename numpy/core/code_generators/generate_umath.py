...
'multiply':
    Ufunc(2, 1, One,
          ...
          [TypeDescription('m', FullTypeDescr, 'mk', 'm'),
           TypeDescription('m', FullTypeDescr, 'km', 'm'),
...
'floor_divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          ...
          [TypeDescription('m', FullTypeDescr, 'mk', 'm'),
           TypeDescription('m', FullTypeDescr, 'md', 'm'),
           TypeDescription('m', FullTypeDescr, 'mm', 'k'),
          ],
...
'divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          ...
          [TypeDescription('m', FullTypeDescr, 'mk', 'm', cfunc_alias='divide'),
...
'greater':
    Ufunc(2, 1, None,
          ...
          TD(bints, out='?'),
          [TypeDescription(int64, FullTypeDescr, int64+uint64, '?'),
           TypeDescription(int64, FullTypeDescr, uint64+int64, '?')],
...
'divmod':
    Ufunc(2, 2, None,
          ...
          TD(ints, dispatch=[('loops_modulo', ints)]),
          TD(flts),
          [TypeDescription('m', FullTypeDescr, 'mm', 'km')],
